# AUTOGENERATED! DO NOT EDIT! File to edit: ../src/00_TreeClusters.ipynb.

# %% auto 0
__all__ = ['module_path', 'inside_polygon', 'poligon_non_convex_from_Points', 'poligon_non_convex_random_gen',
           'string_recursive_tag', 'retag_from_strings', 'cluster', 'NodeCluster', 'TreeClusters']
    ...
    def viewer_cluster(self, ax,  **kwargs):
        ...
        Vizualization of the cluster 
            ...
            ----------
                ...
                color_cluster : str
                    Matplotlib color 
                alpha_cluster : double 
                    Alpha channel (Default = 0.5) 
                size_children : double 
                    Point size children (Default = 1)
                color_children : str 
                    matplotlib color
                alpha_children : double
                    Alpha channel of th children (Default = 0.5) 
                polygon_color_children: bool
                    Plot the children polygon
